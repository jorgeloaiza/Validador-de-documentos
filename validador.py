...
def iniciar_validacion():  # esta función realiza el proceso de comprobación de registro de los documentos
    try:
        ...
        driver.get('http://oferta.senasofiaplus.edu.co/sofia-oferta/registro.html')
        ...
        for i in range(ultima_fila_con_datos):
            ...
            if display.is_displayed() == True:  # si es igual a True es porque apareció el aviso emergente, lo que significa que el documento ya está registrado
                sheet.cell(i + 1,
                           1).fill = fill_pattern_verde  # rellena de verde la celda donde está el documento ya validado
...
if __name__ == '__main__':
    ...
    root.iconbitmap('C:/Users/jelm4/PycharmProjects/pythonProject/iconoes.ico')  # ubica el ícono en la ventana principal
